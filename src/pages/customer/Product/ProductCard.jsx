...
const ProductCard = ({
  ...
  return (
    <div className="border rounded-md shadow-md p-2 relative w-full sm:w-[220px] sm:h-[476px] ml-2 mt-3">
    <div className="group hover:scale-105 transition-transform duration-300 relative mt-[40px] w-full sm:w-[198.4px] sm:h-[198.4px] mx-auto">
    ...
    <h2 className="font-bold text-base mt-6 text-left">{productName}</h2>
  
    <div className="text-left mt-1">
      <span className="text-[#E90628] text-[18px] font-bold">
        {productPrice}
      </span>
    </div>
