  ...
  return (    <div className="bg-[#F2F2F2]">
      ...
      <div className="container mx-auto px-4 lg:px-[160px] bg-transparent">
        <div className="p-6 rounded-lg flex flex-col lg:flex-row gap-2.5">
          ...
          {/* Tên sản phẩm và giá */}
          <div className="absolute bottom-[-70px] w-full  lg:-ml-[383px] text-black text-center hidden lg:block ">
          ...
          <div className="flex flex-col justify-center items-center mt-4 lg:mt-[-110px] lg:-mr-[80px] gap-5 ">
            ...
            <button  onClick={prevImg1} className="absolute left-0 top-1/2 transform -translate-y-1/2 z-10 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              <icons.IoIosArrowDropleftCircle className="text-gray-200 text-4xl" />
            </button>
              <div
                className=" flex transition-transform duration-700 ease-in-out"
              ...
              <button  onClick={nextImg1} className="absolute right-0 top-1/2 transform -translate-y-1/2 z-10 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              <icons.IoIosArrowDroprightCircle className="text-gray-200 text-4xl" />
            </button>
            </div>
            ...
            {/* Thẻ cho ảnh thứ hai */}
            <div className="relative overflow-hidden w-full h-auto lg:w-[390px] lg:h-[190px] group">
            <button  onClick={prevImg2} className="absolute left-0 top-1/2 transform -translate-y-1/2 z-10 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              <icons.IoIosArrowDropleftCircle className="text-gray-200 text-4xl" />
            </button>
              <div
                className="flex transition-transform duration-700 ease-in-out"
              ...
              <button  onClick={nextImg2} className="absolute right-0 top-1/2 transform -translate-y-1/2 z-10 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              <icons.IoIosArrowDroprightCircle className="text-gray-200 text-4xl" />
            </button>
            </div>
          </div>
