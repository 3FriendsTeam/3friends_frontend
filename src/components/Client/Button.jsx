...
const Button = ({ text, textColor, bgColor, IcAfter }) => {
  return (
    <div className="relative group">
      ...
      <div className="fixed left-0 right-0 top-[60px] w-screen h-[300px] mt-[100px] bg-[#FFFFFF] invisible group-hover:visible opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-50 border-t border-gray-300">
